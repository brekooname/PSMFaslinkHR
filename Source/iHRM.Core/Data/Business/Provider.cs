...
namespace iHRM.Core.Business
{
    ...
    public class Provider
    {
        ...
        private static string _ConnectionString_Files = null;
        ...
        public static string ConnectionString_Files
        {
            get
            {
                return _ConnectionString_Files;
            }
            set
            {
                _ConnectionString_Files = value;
            }
        }
        ...
        public static SqlParameter CreateParameter_IntList(string paName, Array arr)
        {
            var pa = new SqlParameter(paName, SqlDbType.Structured);
            DataTable dt = new DataTable();
            dt.Columns.Add("VALUE");
        ...
        public static SqlParameter CreateParameter_StringList(string paName, string str)
        {
            var pa = new SqlParameter(paName, SqlDbType.Structured);
            DataTable dt = new DataTable();
            dt.Columns.Add("VALUE");
