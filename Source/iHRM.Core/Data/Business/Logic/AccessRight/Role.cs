...
namespace iHRM.Core.Business.Logic.AccessRight
{
    public class Role : LogicBase
    {
        public class ruleAlias
        {
            ...
            public ruleAlias(w5sysFunction func, long rules, long customRules)
            {
                id = func.id;
            ...
            public long customRule { get; set; }
        ...
        public List<Role.ruleAlias> BuildTreeFunction(IQueryable<w5sysRule> lst, int flatForm)
        {
            ...
            foreach (var func in lstFunc)
            {
                ...
                if (r == null)
                    lstRA.Add(new Role.ruleAlias(func, 0, 0));
                else
                    lstRA.Add(new Role.ruleAlias(func, r.rules, r.customRules ?? 0));
            }
