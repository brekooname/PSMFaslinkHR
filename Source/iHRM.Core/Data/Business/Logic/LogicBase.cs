...
namespace iHRM.Core.Business.Logic
{
    ...
    public class LogicBase
    {
        ...
        public VirtualPagingInfo VirtualPaging //Thong Lieu: '19-12-2018' 
        {
        ...
        public LogicBase() //Thong Lieu: '19-12-2018' 
        {
        ...
        public virtual DataTable GetAllDep(string tablename, params SqlParameter[] pa) //Thong Lieu: '19-12-2018'
        {
            DataTable dts = new DataTable();
            SqlConnection cnn = Provider.CreateConnection();
            SqlCommand cmd = new SqlCommand(tablename, cnn);
            cmd.CommandType = CommandType.StoredProcedure;
