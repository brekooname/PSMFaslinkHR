...
namespace iHRM.Core.Business.Logic.Luong
{
    public class TinhLuong
    {
        ...
        public DataTable getSoNguoiPhuThuoc(List<string> _lEmpID, DateTime tuNgay, DateTime denNgay)
        {
            return Provider.ExecuteDataTable("p_tblEmpPIT_Family_GetAll",
        ...
        public DataTable getTamUng(List<string> _lEmpID, DateTime tuNgay, DateTime denNgay)
        {
            return Provider.ExecuteDataTable("p_tbTamUng_GetAll",
                Provider.CreateParameter_StringList("dtEmpID", _lEmpID),
                new SqlParameter("tuNgay", tuNgay),
                new SqlParameter("denNgay", denNgay)
            );
