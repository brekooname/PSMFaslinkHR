...
namespace iHRM.Win.UC
{
    public partial class ButtonPanel : ToolStrip
    {
        ...
        public void Init()
        {
            ...
            this.Font = new System.Drawing.Font("Times New Roman", 12);
        }
        ...
        {
            if (_useButtonFind)
                btnFind.Enabled = isAdmin || BitHelper.Has(r, (int)Enums.eFunction.Find);
            if (_useButtonNew)
            ...
            if (_useButtonSave)
                btnSave.Enabled = isAdmin || BitHelper.Has(r, (int)Enums.eFunction.Save);
        }
        ...
        public void setFunctionVisible(int r)
        {
            ...
            if (_useButtonSave)
                btnSave.Visible = isAdmin || BitHelper.Has(r, (int)Enums.eFunction.Save);
        }
