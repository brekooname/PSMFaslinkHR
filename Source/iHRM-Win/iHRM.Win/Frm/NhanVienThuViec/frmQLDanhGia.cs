...
namespace iHRM.Win.Frm.NhanVienThuViec
{
    public partial class frmQLDanhGia : dlgBase
    {
        ...
        protected override void FormSetData()
        {
            ...
            //DateTime x = Convert.ToDateTime( this.MyValue["NgayKetThuc"] );
            //if (x < new DateTime(2018,03,26))
            //{
            //    date_GDNgay.Enabled = false;
            //    chkGDXN.Enabled = false;
            //}
        ...
        public void AddControlBinding()
        {
            ...
            dlgData.CB.Add(new ControlBinding("NgayKetThuc", dateNgayKetThuc, ControlBinding_DataType.DateTime));
        ...
        public void PhanQuyen(string value)
        {
            switch (value)
            {
                case "Quản lý":
                    {
                        tbPheDuyet.PageVisible = false;
                        groupControl12.Enabled = true;
                        groupControl3.Enabled = true;
                        cboNguoiQuanLy.Enabled = groupControl13.Enabled = true;
                ...
                case "Trưởng Phòng":
                    {
                        ...
                        cboTruongPhong.Enabled = groupControl5.Enabled = true;

                        grbGiamDoc.Enabled = false;
        ...
        {
            txtKienThucChuyenMonKhac.Enabled = radKienThucChuyenMon.SelectedIndex == 3 ? true : false;
        ...
        {
            txtKinhNghiemLamViecKhac.Enabled = radkinhNghiemLamViec.SelectedIndex == 3 ? true : false;
        ...
        {
            txtKhaNangTiepThu.Enabled = radKhaNang.SelectedIndex == 2 ? true : false;
        ...
        {
            txtHieuQuaCongViec.Enabled = radHieuQuaCongViec.SelectedIndex == 2 ? true : false;
        ...
        {
            txtTuLapKeHoach.Enabled = radTuLapKeHoach.SelectedIndex == 2 ? true : false;
        ...
        {
            txtKhaNangGiaoTiep.Enabled = radKhaNangGiaoTiep.SelectedIndex == 2 ? true : false;
        ...
        {
            txtSangTaoTrongCongViec.Enabled = radSangTaoCV.SelectedIndex == 2 ? true : false;
        ...
        {
            txtThaiDoTuGiac.Enabled = radTinhThanTuGiac.SelectedIndex == 3 ? true : false;
        ...
        {
            txtThaiDoTrungThuc.Enabled = radTinhTrungThuc.SelectedIndex == 3 ? true : false;
        ...
        {
            txtThaiDoHocHoi.Enabled = radTinhThanHocHoi.SelectedIndex == 3 ? true : false;
        ...
        {
            txtThaiDoTrachNhiem.Enabled = radCoTrachNhiem.SelectedIndex == 3 ? true : false;
        ...
        {
            txtThaiDoDeXuat.Enabled = radCoNhungDeXuat.SelectedIndex == 3 ? true : false;
        ...
        private void radHoTroDongNghiep_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtThaiDoHoTro.Enabled = radHoTroDongNghiep.SelectedIndex == 3 ? true : false;
