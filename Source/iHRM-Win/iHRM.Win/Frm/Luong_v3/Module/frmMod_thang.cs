...
{
    public partial class frmMod_thang : frmBase
    {
        dcLuongv3DataContext db = new dcLuongv3DataContext(Core.Business.Provider.ConnectionString);
        //List<tbLuongTS_TruthDef> LstData;

        public Guid? ModId
        {
            get { return txtMod.EditValue as Guid?; }
            set
            {
                txtMod.EditValue = value;
            }
        }
        ...
        public frmMod_thang()
        {
            ...
            txtMod.Properties.DataSource = db.tbLuongTS_ModuleDefs.Where(i => i.loai == "thang").ToList();
        }
        ...
        {
            var r = grv.GetRow(e.RowHandle) as tbMod_thang;
            if (r != null)
            {
                r.id = Guid.NewGuid();
                r.moduleDef_id = ModId;
            }
        }

        private void txtMod_EditValueChanged(object sender, EventArgs e)
        {
            grd.DataSource = db.tbMod_thangs.Where(i => i.moduleDef_id == ModId);
        }
        ...
        #endregion
        private void frmMod_thang_KeyDown(object sender, KeyEventArgs e)
        {
