...
{
    public partial class frmCongThucTinh_Tax : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            ...
            var log = Log2.CreateLog(Log2.Log2Action.sua, "Sửa công thức lương " + myValue.id, "tbCongThucTinh_Tax");
        ...
        {
            var ct = new tbCongThucTinh_Tax();
            ct.id = Guid.NewGuid();
            ct.ten = ten;
            ct.noidung = "";

            dcLuongv3DataContext db = new dcLuongv3DataContext(Core.Business.Provider.ConnectionString);
            db.tbCongThucTinh_Taxes.InsertOnSubmit(ct);
            db.SubmitChanges();
