...
{
    public partial class frmDinhNghiaThamSo_ModuleSelect : frmBase
    {
        ...
        public frmDinhNghiaThamSo_ModuleSelect()
        {
            InitializeComponent();
        }
        ...
        {
            txtModule.Properties.DataSource = db.tbLuongTS_ModuleDefs.ToList();
        }
