...
{
    public partial class dlgChuyenBangThue_LuongBaoCao : DevExpress.XtraEditors.XtraForm
    {
      

        dcLuongv3DataContext db = new dcLuongv3DataContext(Core.Business.Provider.ConnectionString);

        public dlgChuyenBangThue_LuongBaoCao()
        {
            InitializeComponent();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (IsLock.IsLock.Check_IsLock("tbLuong_NhapDuLieu_Fake", new DateTime(txt_ThangThue.DateTime.Year, txt_ThangThue.DateTime.Month, 1)))
            {
                GUIHelper.MessageBox("Dữ liệu lương báo cáo đã chốt khổng thể thao tác!");
                return;
            }

            try
            {
                Provider.ExecuteDataTableReader("p_luong_layDuLieuThue_LuongBaoCao",
                ...
                var log = Log2.CreateLog(Log2.Log2Action.phantich, "Chuyển tham số thuế sang tham số lương báo cáo phòng ban  " + chonPhongBan1.SelectedRow.DepName, "tbLuong_NhapDuLieu_Fake");
                ...
                GUIHelper.MessageBox("Chuyển tham số thuế sang tham số lương báo cáo thành công");
