...
{
    public partial class dlgChuyenBangLuong_Thue : DevExpress.XtraEditors.XtraForm
    {
      

        dcLuongv3DataContext db = new dcLuongv3DataContext(Core.Business.Provider.ConnectionString);

         public dlgChuyenBangLuong_Thue()
        {
            InitializeComponent();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Provider.ExecuteDataTableReader("p_luong_layDuLieuLuong_Thue",
                ...
                var log = Log2.CreateLog(Log2.Log2Action.phantich, "Chuyển tham số lương sang tham số thuế phòng ban  " + chonPhongBan1.SelectedRow.DepName, "tbLuong_NhapDuLieu_Tax");
                ...
                GUIHelper.MessageBox("Chuyển tham số lương sang tham số thuế thành công");
