...
{
    public partial class frmBangLuongThang : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                var lst1 = db.tbNhanVien_ThamSoLuongs.Where(i => i.nhomnv_id == txtNhomNV.EditValue as int? 
                    && i.tbLuong_DinhNghiaThamSo.hienTrenBangLuong == true).Select(i => i.tbLuong_DinhNghiaThamSo).OrderBy(p => p.ten).ToList();
                ...
                LstData = Provider.ExecuteDataTableReader("p_BangLuong_GetAll",
                    ...
                    new SqlParameter("nhomnv_id", txtNhomNV.EditValue),
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var log = Log2.CreateLog(Log2.Log2Action.sua, "Sửa bảng lương " + DbHelper.DrGet(r, "id"), "tbLuong_BangLuongThang");
                ...
                Provider.UpdateData(LstData, "tbLuong_BangLuongThang");
        ...
        private void btnEmail_Click(object sender, EventArgs e)
        {
            ...
            var lst1 = db1.tbNhanVien_ThamSoLuongs.Where(i => i.nhomnv_id == txtNhomNV.EditValue as int?).Select(i => i.tbLuong_DinhNghiaThamSo).ToList();
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                var lst = Provider.ExecuteDataTableReader("p_BangLuong_GetAll",
                    new SqlParameter("thang", new DateTime(txtSearchThang.DateTime.Year, txtSearchThang.DateTime.Month, 1)),
                    new SqlParameter("nhomnv_id", txtNhomNV.EditValue),
                    new SqlParameter("phongban_id", chonPhongBan1.SelectedValue),
                    new SqlParameter("tukhoa", txtTuKhoaSearch.Text.Trim())
        ...
        private void IN_PHIEU_LUONG(DataTable lst)
        {
            try
            {
                ...
                var xuatBL = db1.tbLuong_XuatBangLuongs.Where(i => i.loai == "html" && i.status == 1).ToList();
                ...
                var tempPath = (cn.SelectedRow as tbLuong_XuatBangLuong).duongdan.Replace("/", "\\");
                ...
                tempPath = Path.Combine(win_globall.apppath, "ExcelTemplate\\Luong" + tempPath);
                ...
                dw_it.OnDoing = (s, ev) =>
                {
                    try
                    {
                        ...
                        List<tbLuong_DinhNghiaThamSo> lst1;

                        if (txtNhomNV.EditValue == null)

                            lst1 = db.tbLuong_DinhNghiaThamSos.ToList();

                        else

                            lst1 = db.tbNhanVien_ThamSoLuongs.Where(i => i.nhomnv_id == txtNhomNV.EditValue as int?).Select(i => i.tbLuong_DinhNghiaThamSo).ToList();
        ...
        private void tsm_BangLuongTamUngDH_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/DH_BangLuongTamUng.xls");

                    ex.WriteToCell("A4", "KỲ LƯƠNG THÁNG " + string.Format("{0:MM-yyyy}", txtSearchThang.DateTime));

                    ex.WriteToCell("A10", "Đông Hưng, ngày " + string.Format("{0:dd}", DateTime.Now) + " tháng " + string.Format("{0:MM}", DateTime.Now) + " năm " + string.Format("{0:yyyy}", DateTime.Now));

                    var dtData = Provider.ExecuteDataTableReader("p_BangLuong_GetAll_TamUng",
                        new SqlParameter("thang", new DateTime(txtSearchThang.DateTime.Year, txtSearchThang.DateTime.Month, 1)),
                        new SqlParameter("phongban_id", chonPhongBan1.SelectedValue),
                        new SqlParameter("nhomnv_id", txtNhomNV.EditValue)
                    );
                    ...
                    ex.RendAndFlushTotal("DH_BangLuongTamUng", sd.FileName);
        ...
        private void tsm_BangLuongTamUngNV_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/NV_BangLuongTamUng.xls");

                    ex.WriteToCell("A4", "KỲ LƯƠNG THÁNG " + string.Format("{0:MM-yyyy}", txtSearchThang.DateTime));

                    ex.WriteToCell("A10", "Nam Việt, ngày " + string.Format("{0:dd}", DateTime.Now) + " tháng " + string.Format("{0:MM}", DateTime.Now) + " năm " + string.Format("{0:yyyy}", DateTime.Now));
                    ...
                    ex.RendAndFlushTotal("NV_BangLuongTamUng", sd.FileName);
        ...
        private void tsm_BangLuongTamUngBVNV_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/NV_BangLuongTamUngBV.xls");
        ...
        private void tsm_BangLuongPBDH_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/DH_BangTongHopLuongPB.xls");

                    ex.SetNamedRangeValue("Kyluong", "Tháng " + string.Format("{0:MM-yyyy}", txtSearchThang.DateTime));
                    ex.SetNamedRangeValue("Ngay", string.Format("Đông Hưng, ngày {0:dd} tháng {0:MM} năm {0:yyyy}", DateTime.Now));

                    var dtData = Provider.ExecuteDataTableReader("p_BangLuong_GetAll_GroupDept",
                        new SqlParameter("thang", new DateTime(txtSearchThang.DateTime.Year, txtSearchThang.DateTime.Month, 1)),
                        new SqlParameter("phongban_id", chonPhongBan1.SelectedValue)
                    );
                    ...
                    ex.RendAndFlushTotal("DH_BangtonghopluongPB", sd.FileName);
        ...
        private void tsm_BangLuongPBTTCPDH_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/DH_BangTongHopLuongTTCP.xls");

                    ex.SetNamedRangeValue("Kyluong", "Tháng " + string.Format("{0:MM-yyyy}", txtSearchThang.DateTime));
                    ex.SetNamedRangeValue("Ngay", string.Format("Đông Hưng, ngày {0:dd} tháng {0:MM} năm {0:yyyy}", DateTime.Now));

                    var dtData = Provider.ExecuteDataTableReader("p_BangLuong_GetAll_GroupCenterCost",
                        new SqlParameter("thang", new DateTime(txtSearchThang.DateTime.Year, txtSearchThang.DateTime.Month, 1)),
                        new SqlParameter("phongban_id", chonPhongBan1.SelectedValue)
                    );
                    ...
                    ex.RendAndFlushTotal("DH_BangTongHopLuongTTCP", sd.FileName);
        ...
        private void tsm_BangLuongPBNV_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/NV_BangTongHopLuongPB.xls");

                    ex.SetNamedRangeValue("Kyluong", "Tháng " + string.Format("{0:MM-yyyy}", txtSearchThang.DateTime));
                    ex.SetNamedRangeValue("Ngay", string.Format("Nam Việt, ngày {0:dd} tháng {0:MM} năm {0:yyyy}", DateTime.Now));
                    ...
                    ex.RendAndFlushTotal("NV_BangtonghopluongPB", sd.FileName);
        ...
        private void tsm_BangLuongPBTTCPNV_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/NV_BangTongHopLuongTTCP.xls");
                    ...
                    ex.RendAndFlushTotal("NV_BangTongHopLuongTTCP", sd.FileName);
        ...
        private void tsm_BangLuongTamUngPBDH_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/DH_BangTongHopLuongTamUngPB.xls");

                    ex.WriteToCell("A4", "KỲ LƯƠNG THÁNG " + string.Format("{0:MM-yyyy}", txtSearchThang.DateTime));

                    ex.WriteToCell("A11", "Đông Hưng, ngày " + string.Format("{0:dd}", DateTime.Now) + " tháng " + string.Format("{0:MM}", DateTime.Now) + " năm " + string.Format("{0:yyyy}", DateTime.Now));
                    ...
                    var dtData_In = dtData.Select(@"ts54 > 0", "OrderNo ASC").CopyToDataTable();
                    ...
                    ex.RendAndFlushTotal("DH_BangTongHopLuongTamUngPB", sd.FileName);
        ...
        private void tsm_BangLuongTamUngPBNV_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/NV_BangTongHopLuongTamUngPB.xls");

                    ex.WriteToCell("A4", "KỲ LƯƠNG THÁNG " + string.Format("{0:MM-yyyy}", txtSearchThang.DateTime));

                    ex.WriteToCell("A11", "Nam Việt, ngày " + string.Format("{0:dd}", DateTime.Now) + " tháng " + string.Format("{0:MM}", DateTime.Now) + " năm " + string.Format("{0:yyyy}", DateTime.Now));
                    ...
                    ex.RendAndFlushTotal("NV_BangTongHopLuongTamUngPB", sd.FileName);
        ...
        private void tsm_BangLuongTamUngATMDH_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/DH_BangluongungATM.xls");
                    ...
                    ex.RendAndFlushTotal("DH_BangluongungATM", sd.FileName);
        ...
        private void tsm_BangLuongTamUngATMNV_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/NV_BangluongungATM.xls");
                    ...
                    ex.RendAndFlushTotal("NV_BangluongungATM", sd.FileName);
        ...
        private void tsm_PhieuLuongSMSDH_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/DH_PhieuluongSMS.xls");

                    ex.WriteToCell("H6", "KỲ LƯƠNG THÁNG " + string.Format("{0:MM-yyyy}", txtSearchThang.DateTime));
                    ...
                    ex.RendAndFlushTotal("DH_PhieuluongSMS", sd.FileName);
        ...
        private void tsm_BangLuongATMDH_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/DH_BangluongATM.xls");
                    ...
                    ex.RendAndFlushTotal("DH_BangluongATM", sd.FileName);
        ...
        private void tsm_BangLuongATMNV_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/NV_BangluongATM.xls");
                    ...
                    ex.RendAndFlushTotal("NV_BangluongATM", sd.FileName);
        ...
        private void tsm_PhieuLuongSMSNV_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog();
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                try
                {
                    var ex = new ExcelExportHelper("Luong/NV_PhieuluongSMS.xls");
                    ...
                    ex.RendAndFlushTotal("NV_PhieuluongSMS", sd.FileName);
        ...
        private void frmBangLuongThang_KeyDown(object sender, KeyEventArgs e)
        {
