...
{
    public partial class dlgDinhNghiaThamSo_Fake : dlgCustomBase
    {
        dcLuongv3DataContext db = new dcLuongv3DataContext(Core.Business.Provider.ConnectionString);
        public List<tbLuong_DinhNghiaThamSo_Fake> LstThamSo
        {
            set
            {
                frmCongThucTinh_Fake.lstPara.Clear();
                if (value != null)
                {
                    frmCongThucTinh_Fake.lstPara.AddRange(value.Select(i => new frmCongThucTinh_Fake.lstItem()
                    {
                        Name = i.ma,
                        Description = i.ten,
                        nhom = i.nhom
        ...
        private tbLuong_DinhNghiaThamSo_Fake myValue;
        public tbLuong_DinhNghiaThamSo_Fake MyValue
        {
            get { return myValue; }
            set
            {
        ...
        frmCongThucTinh_Fake dlgCalcEditor = new frmCongThucTinh_Fake();

        public dlgDinhNghiaThamSo_Fake()
        {
            InitializeComponent();
        }
        ...
        private void btnCauHinh_Click(object sender, EventArgs e)
        {
            ...
            switch (txtKieuNhap.SelectedIndex)
            {
                case 1: // " Cấu hình module";
                    var frm2 = new frmDinhNghiaThamSo_ModuleSelect_Fake();
                ...
                case 2: // " Cấu hình công thức";
                    if (myValue.congthuc_id == null)
                        myValue.congthuc_id = frmCongThucTinh_Fake.newCT();
        ...
        private void btnCauHinh2_Click(object sender, EventArgs e)
        {
            ...
            var frm = new frmDinhNghiaThamSo_TruthDef_Fake();
            frm.MyId = myValue.id;
            frm.ShowDialog();
        }
