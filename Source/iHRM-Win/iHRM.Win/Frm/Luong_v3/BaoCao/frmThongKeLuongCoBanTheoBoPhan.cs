...
{
    public partial class frmThongKeLuongCoBanTheoBoPhan : frmBase
    {
        ...
        public frmThongKeLuongCoBanTheoBoPhan()
        {
            InitializeComponent();
        }
        ...
        {
            txtSearchThang.EditValue = new DateTime(DateTime.Today.Year,DateTime.Now.Month, 1);
            TranslateForm();
        }
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                int _name = txtSearchThang.DateTime.Year;
                LstData = Provider.ExecuteDataTableReader("p_BangBaoCaoThueDoanhNghiep_GetAll",
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            string temp = "Luong\\Baocaothuedoanhnghiep.xls";        
            ...
            ex.SetNamedRangeValue("thang", string.Format("{0:MM-yyyy}", txtSearchThang.DateTime));
            var dtData = Provider.ExecuteDataTableReader("p_BangBaoCaoThueDoanhNghiep_GetAll",
                    new SqlParameter("thang", new DateTime(txtSearchThang.DateTime.Year, txtSearchThang.DateTime.Month, 1)),
                    new SqlParameter("phongban_id", chonPhongBan1.SelectedValue));
            ex.FillDataTable_DSNL(LstData);
            ex.RendAndFlush("DETAIL", sd.FileName);
            ...
            var log = Log2.CreateLog(Log2.Log2Action.them, "Xuất file Excel danh sách báo cáo đóng thuế doanh nghiệp: " + string.Format("{0:MM/yyyy}", txtSearchThang.DateTime), "tbLuong_BangLuongThang");
        ...
        #endregion
        private void frmThongKeLuongCoBanTheoBoPhan_KeyDown(object sender, KeyEventArgs e)
        {
