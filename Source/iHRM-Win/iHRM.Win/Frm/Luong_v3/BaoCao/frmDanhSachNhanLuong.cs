...
{
    public partial class frmDanhSachNhanLuong : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            {
                LstData = Provider.ExecuteDataTableReader("p_BangLuong_DsNhanLuong_Lan1", 
            ...
            {
                LstData = Provider.ExecuteDataTableReader("p_BangLuong_DsNhanLuong_Lan2",
                    new SqlParameter("thang", new DateTime(txtSearchThang.DateTime.Year, txtSearchThang.DateTime.Month, 1)),
                    new SqlParameter("phongban_id", chonPhongBan1.SelectedValue),
                    new SqlParameter("tukhoa", txtTuKhoaSearch.Text.Trim()),
                    new SqlParameter("hinhthuctraluong", checkEditNhanTienMat.Checked ? "0" : "1"));
            ...
            dw_it.OnProcessing = (ps, data) =>
            {
                ...
                {
                    colSoTien.SummaryItem.FieldName = colSoTien.FieldName = cmbKyLuong.SelectedIndex == 0 ? "ts84" : "ts85";
                    ...
                    foreach(var pb in LstData.Select().Select(i => i["nv_phongban"] as string).Distinct())
                        dic.Add(pb, Convert.ToDouble(LstData.Compute("SUM(" + (cmbKyLuong.SelectedIndex == 0 ? "ts84" : "ts85") + ")", "nv_phongban='" + pb + "'")));
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            if (cmbKyLuong.SelectedIndex == 0)
            {
                temp = checkEditNhanTienMat.Checked ? "Luong\\chuyenLuongTM.xls" : "Luong\\chuyenLuongNH.xls";
            }
            else
            {
                temp = checkEditNhanTienMat.Checked ? "Luong\\chuyenLuongTM_2.xls" : "Luong\\chuyenLuongNH_2.xls";
            }
        ...
        private void frmDanhSachNhanLuong_KeyDown(object sender, KeyEventArgs e)
        {
