...
namespace iHRM.Win.Frm.Luong_v3.BaoCao
{
    public partial class frmDanhSachNhomHL : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s,ev) => 
            {
                dt = Provider.ExecuteDataTableReader("p_Luong_DSNhomHL");
        ...
        private void frmDanhSachNhomHL_KeyDown(object sender, KeyEventArgs e)
        {
