...
{
    public partial class frmRequestOverTime_KhongQuet_v1 : frmBase
    {
        ...
        dlgRequestOverTime_KhongQuet dlgDKTangCa;

        bool isDuyet = false;

        public frmRequestOverTime_KhongQuet_v1()
        {
            InitializeComponent();
        }
        ...
        {
            frmRequestOverTime_KhongQuet_v1_Load(null, null);
        }
        //Test dữ liệu


        private void frmRequestOverTime_KhongQuet_v1_Load(object sender, EventArgs e)
        {
                ...
                foreach (DataRow dr in dt.GetChanges().Rows)
                {
                    if (dr.RowState == DataRowState.Deleted)
                    {
                        ...
                        _lActionClass.Add(new ActionClass("Xóa dữ liệu"
                            ...
                            + string.Format("{0: dd/MM/yyyy}", Ngay), "tbRequestOverTime_KhongQuet"));
                    }
                }
        ...
        private void toolStripThem_Click(object sender, EventArgs e)
        {
            ...
            {
                dlgDKTangCa = new dlgRequestOverTime_KhongQuet();
