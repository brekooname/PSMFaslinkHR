...
{
    public partial class dlgRequestOverTime_v1 : dlgCustomBase
    {
        ...
        public dlgRequestOverTime_v1()
        {
            InitializeComponent();
        }

        private void dlgRequestOverTime_v1_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void dlgRequestOverTime_v1_Load(object sender, EventArgs e)
        {
            ...
            this.Form_Title = Provider.ExecuteDataSetReader("p_Translate", new System.Data.SqlClient.SqlParameter("CtrName", "dlgRequestOverTime_v1_Title")).Tables[0].Rows[0][LoginHelper.langTrans].ToString();

            this.Form_Description = Provider.ExecuteDataSetReader("p_Translate", new System.Data.SqlClient.SqlParameter("CtrName", "dlgRequestOverTime_v1_Description")).Tables[0].Rows[0][LoginHelper.langTrans].ToString();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) =>
            {
                ...
                foreach (string empID in _lEmp)
                {
                    ...
                    if (IsLock.IsLock.Check_IsLock_Type("tbRequestOverTime", _day, 1))
                    {
                        dw_it.bw.ReportProgress(2, string.Format("Dữ liệu đã chốt công ngày {0:dd/MM/yyyy} khổng thể thao tác!\r\n", _day));
                        continue;
                    }
                    if (IsLock.IsLock.Check_IsLock_Type("tbRequestOverTime", _day, 2))
                    {
        ...
        private void dlgRequestOverTime_v1_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Control && e.Shift && e.KeyCode == Keys.T)
            {
                ...
                frm.ShowDialog();
                dlgRequestOverTime_v1_Load(null, null);
