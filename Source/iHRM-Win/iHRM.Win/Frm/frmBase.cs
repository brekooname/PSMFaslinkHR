...
namespace iHRM.Win.Frm
{
    ...
    {
        private w5sysRule _iRule = null;
        public w5sysRule iRule
        {
            get
            {
                if (_iRule == null)
                    _iRule = new w5sysRule();
                return _iRule;
            }
            set { _iRule = value; }
        }
        ...
        /// <returns></returns>
        public static bool AddOrUpdateDbFile(Guid idFile, int action, Binary dataFiles = null, string duoiFile = null, string tenFile = null)
        {
