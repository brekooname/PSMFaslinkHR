    ...
    public partial class frmUser2Role : frmBase
    {
        ...
        private void dlgEditor_OnSave(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dlgEditor.CustomFormAction == 0)
                {
                    ...
                    LogAction.LogAction.PushLog("Thêm dữ liệu", "", "", string.Format("Thêm nhóm quyền"), "w5sysRole");
                ...
                else
                {
                    ...
                    LogAction.LogAction.PushLog("Sửa dữ liệu", "", "", string.Format("Cập nhật nhóm quyền"), "w5sysRole");
        ...
        private void buttonPanel1_OnDelete(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                LogAction.LogAction.PushLog("Xóa dữ liệu", "", "", string.Format("Xóa nhóm quyền"), "w5sysRole");
        ...
        private void buttonPanel2_OnNew(object sender, EventArgs e)
        {
            ...
            if (dlgAddUser.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    LogAction.LogAction.PushLog("Thêm dữ liệu", "", "", string.Format("Thêm người dùng vào nhóm quyền"), "w5sysUser");
