        ...
        private void dlgEditor_OnSave(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dlgEditor.myID == null || db.w5sysFunctions.Where(p => p.id == Convert.ToInt64(dlgEditor.myID)).FirstOrDefault() == null)
                {
                    ...
                    LogAction.LogAction.PushLog("Thêm dữ liệu", "", "", "Thêm chức năng hệ thống", "w5sysFunction");
                ...
                else
                {
                    ...
                    LogAction.LogAction.PushLog("Sửa dữ liệu", "", "", "Cập nhật chức năng hệ thống", "w5sysFunction");
        ...
        private void buttonPanel1_OnDelete(object sender, EventArgs e)
        {
            ...
            if (it != null)
            {
                try
                {
                    ...
                    LogAction.LogAction.PushLog("Xóa dữ liệu", "", "", "Xóa chức năng hệ thống", "w5sysFunction");
