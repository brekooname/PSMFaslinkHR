...
{
    public partial class BCNhanVienVangMat : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s,ev) => //hàm lấy dữ liệu chạy ngầm
            {
                ...
                {
                    string LoaiNghi = Convert.ToString(lookupLoaiNghi.EditValue);
                    data = controller.GetReportNhanVienVangMat(day, todates, LoaiNghi, ucChonDoiTuong_DS1.GetValue());
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel báo cáo nhân viên vắng mặt"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportNhanVienVangMat.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("ReportNhanVienVangMat_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        {
            lookupLoaiNghi.Properties.DataSource = db.tblRef_LeaveTypes.ToList();
            LoadGrvLayout(grv);
            TranslateForm();
        }
        ...
        #endregion
        private void BCNhanVienVangMat_KeyDown(object sender, KeyEventArgs e)
        {
