...
{
    public partial class BCConTho : frmBase
    {
        ...
        {
            mocTG = DateMocTG.DateTime;
            dtData = Provider.ExecuteDataTableReader("p_BaoCao_GetReportConTho",
                Provider.CreateParameter_StringList("EmployeeID", ucChonDoiTuong_DS1.GetValue()),
                new SqlParameter("@MocTG", mocTG)
                );
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel con thơ"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/Report_BaoCaoConTho.xls"); // Tạo excel export helper + đường dẫn template
                ex.WriteToCell("L6", "Ngày tạo:  " + DateTime.Now.ToString("dd/MM/yyyy"));
                ...
                ex.RendAndFlush("BaoCaoConTho_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCConTho_KeyDown(object sender, KeyEventArgs e)
        {
