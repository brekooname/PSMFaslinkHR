...
{
    public partial class BCThoiGianKyHD : Form
    {
        DataTable dt;
        public BCThoiGianKyHD()
        {
            InitializeComponent();
            dt = new DataTable();
        }
        ...
        {
            Boolean x = IsNumber(txtSoNgay.EditValue.ToString());
            if (x == false)
            {
                txtSoNgay.Focus();
                MessageBox.Show("Bạn phải nhập số ngày kiểu số", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
            }
        ...
        private void toolStripSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt = Provider.ExecuteDataTable("p_RP_EMP_CT_01",
                    new SqlParameter("SoNgay", txtSoNgay.EditValue),
                    new SqlParameter("NgayTinh", deThoiGian.EditValue),
        ...
        private void frmRPThoiGianKiHopDong_Load(object sender, EventArgs e)
        {
            deThoiGian.EditValue = DateTime.Now;
            txtSoNgay.EditValue = 0;
            TranslateForm();
        }
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ge.OnDoing += (bw) =>
                {
                    bw.ReportProgress(-1, "Xuất excel báo cáo thời gian đăng ký hợp đồng"); // Set caption
                    ...
                    ExcelExportHelper ex = new ExcelExportHelper("Report/BCThoiGianKyHD.xls"); // Tạo excel export helper + đường dẫn template
                    ...
                    ex.RendAndFlush("BCThoiGianKyHD_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                    bw.ReportProgress(2);
                    #endregion
                };
        ...
        #endregion
        private void BCThoiGianKyHD_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Control && e.Shift && e.KeyCode == Keys.T)
            {
                ...
                frm.ShowDialog();
                frmRPThoiGianKiHopDong_Load(null, null);
            }
        }
    }
}
