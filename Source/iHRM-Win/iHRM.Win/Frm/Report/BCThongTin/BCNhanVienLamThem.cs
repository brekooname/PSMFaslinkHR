...
{
    public partial class BCNhanVienLamThem : frmBase
    {
        dcDatabaseDataContext db = new dcDatabaseDataContext(Provider.ConnectionString);
        DataTable data = new DataTable();
        public BCNhanVienLamThem()
        {
            InitializeComponent();
        }
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            {
                data = Provider.ExecuteDataTableReader("p_BaoCao_GetReportLamThem",
                          ...
                          new SqlParameter("LoaiLT", slkLoaiLT.EditValue)
                          );
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel dữ liệu nhân viên làm thêm"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportNhanVienLamThem.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("BaoCaoNhanVienLamThem_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCNhanVienLamThem_KeyDown(object sender, KeyEventArgs e)
        {
