...
{
    public partial class BCNhanVienTSThangThu7 : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s,ev) => //hàm lấy dữ liệu chạy ngầm
            {
                ...
                {
                    data = logic.GetReportNhanVienThaiThangThu7(day, todates, ucChonDoiTuong_DS1.GetValue());
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportNhanVienTSThangThu7.xls"); // Tạo excel export helper + đường dẫn template
