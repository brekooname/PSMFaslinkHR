...
{
    public partial class BCNhanVienTangCa : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s,ev) => //hàm lấy dữ liệu chạy ngầm
            {
                ...
                {
                    data = logic.GetReportTangCa6H(day, todates,ucChonDoiTuong_DS1.GetValue());
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel nhân viên tăng ca"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/BaoCaoNhanVienTangCa.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("BaoCaoNhanVienTangCa" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCNhanVienTangCa_KeyDown(object sender, KeyEventArgs e)
        {
