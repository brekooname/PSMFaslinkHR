...
namespace iHRM.Win.Frm.Report
{
    public partial class BCTongHopThongTinCC : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            {
                dt = Provider.ExecuteDataTableReader("p_BaoCao_getDataReportThongTinCC",
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel tổng hợp thông tin CC"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/BaoCaoTongHopThongTinCC.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("BaoCaoTongHopThongTinCC" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCTongHopThongTinCC_KeyDown(object sender, KeyEventArgs e)
        {
