...
{
    public partial class BCQuetTheNgayNew : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            {
                dt = Provider.ExecuteDataTableReader("p_BaoCao_QuetTheKiLuong",
                          new SqlParameter("kiluong", chonKyLuong1.DenNgay.Month),
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel báo cáo quẹt thẻ theo ngày"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/BaoCaoQuetTheTheoNgay_New.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("BaoCaoQuetTheTheoNgay" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCQuetTheNgayNew_KeyDown(object sender, KeyEventArgs e)
        {
