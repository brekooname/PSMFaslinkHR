...
{
    public partial class BCDuLieuQuyetTheGoc : frmBase
    {
        public BCDuLieuQuyetTheGoc()
        {
            InitializeComponent();
        }
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/DuLieuQuyetTheGoc.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("DuLieuQuyetTheGoc_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCDuLieuQuyetTheGoc_KeyDown(object sender, KeyEventArgs e)
        {
