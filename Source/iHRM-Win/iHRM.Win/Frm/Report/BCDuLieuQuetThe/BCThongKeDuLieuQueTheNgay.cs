...
{
    public partial class BCThongKeDuLieuQueTheNgay : frmBase
    {
        ...
        public BCThongKeDuLieuQueTheNgay()
        {
            InitializeComponent();
            ...
            _lLoai.Add(new Loai { loai = "All In - All Out", value = 4 });
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            if (chonKyLuong1.TuNgay != null && chonKyLuong1.DenNgay != null)
            {
                ...
                dt = logic.GetReportQuetTheByDate(day, today, ucChonDoiTuong_DS1.GetValue());
                dt.Columns.Add("TT");
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel dữ liệu quẹt thẻ ngày"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportThongKeDuLieuQuetTheNgay.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.FillDataTable(tbl); // Fill BC_FillData
                ex.RendAndFlush("ThongKeDuLieuQuetTheNgay_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCThongKeDuLieuQueTheNgay_KeyDown(object sender, KeyEventArgs e)
        {
