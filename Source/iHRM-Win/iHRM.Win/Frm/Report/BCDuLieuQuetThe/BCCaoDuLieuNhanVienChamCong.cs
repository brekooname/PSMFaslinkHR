...
{
    public partial class BCCaoDuLieuNhanVienChamCong : frmBase
    {
        ...
        DataTable dt = null;
        public BCCaoDuLieuNhanVienChamCong()
        {
            InitializeComponent();
        }
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) => //hàm lấy dữ liệu chạy ngầm
            {
                ...
                dt = controller.GetDuLieuNhanVienChamCong(ucChonDoiTuong_DS1.GetValue(), chonKyLuong1.TuNgay, chonKyLuong1.DenNgay);
        ...
        private void btnXuatExel_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel thời gian nhân viên chấm công"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/BaoCaoThoiGianNhanVienChamCong.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("BaoCaoThoiGianNhanVienChamCong" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCCaoDuLieuNhanVienChamCong_KeyDown(object sender, KeyEventArgs e)
        {
