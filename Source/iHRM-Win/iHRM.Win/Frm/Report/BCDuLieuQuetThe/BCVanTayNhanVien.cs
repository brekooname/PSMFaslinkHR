...
namespace iHRM.Win.Frm.Report
{
    public partial class BCVanTayNhanVien : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            {
                dt = Provider.ExecuteDataTableReader("p_BaoCao_getDataReportThongTinVanTayNV",
                    new SqlParameter("isTrung", chkisTrung.Checked ? 1: 0),
                    new SqlParameter("isGetAll", chkGetAll.Checked ? 1 : 0),
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel vân tay nhân viên"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/BaoCaoVanTayNhanVien.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("BaoCaoVanTayNhanVien" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCVanTayNhanVien_KeyDown(object sender, KeyEventArgs e)
        {
