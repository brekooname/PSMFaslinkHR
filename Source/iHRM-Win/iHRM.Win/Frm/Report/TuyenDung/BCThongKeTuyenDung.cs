...
{
    public partial class BCThongKeTuyenDung : frmBase
    {
        ...
        {
            LoadGrvLayout(grv);
            lookupViTriTD.Properties.DataSource = db.tblRef_Positions;
            TranslateForm();
        }
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            {
                dt = Core.Business.Provider.ExecuteDataTableReader("p_Report_ThongKeTuyenDung",
                    new SqlParameter("ViTri", lookupViTriTD.EditValue == null || lookupViTriTD.EditValue.ToString() == string.Empty ? null : lookupViTriTD.EditValue),
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel thống kê tuyển dụng"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportThongKeTuyenDung.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("ReportThongKeTuyenDung" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCThongKeTuyenDung_KeyDown(object sender, KeyEventArgs e)
        {
