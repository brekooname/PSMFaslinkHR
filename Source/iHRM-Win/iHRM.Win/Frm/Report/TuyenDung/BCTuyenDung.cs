...
{
    public partial class BCTuyenDung : frmBase
    {
        public BCTuyenDung()
        {
            InitializeComponent();
        ...
        {
            LoadGrvLayout(grv);
            cboNam.Properties.Items.AddRange(Nam());
            cboNam.SelectedIndex = Nam().Count - 1;
            TranslateForm();
        ...
        public List<string> Nam()
        {
            ...
            {
                nam.Add(string.Format("{0:0000}", i));
            }
            return nam;
        }
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s,ev) =>
            {
                dt = Core.Business.Provider.ExecuteDataTableReader("p_TongKetTuyenDung_cuoinam",
                    new SqlParameter("DepID", cboPhongBan.SelectedValue),
                    new SqlParameter("Nam", cboNam.EditValue));
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel báo cáo tuyển dụng"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/BaoCaoTuyenDung.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("BaoCaoTuyenDung" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCTuyenDung_KeyDown(object sender, KeyEventArgs e)
        {
