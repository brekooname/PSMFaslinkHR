...
{
    public partial class BCLichSuTuyenDung : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            {
                dt = Core.Business.Provider.ExecuteDataTableReader("p_Report_TuyenDung",
                    new SqlParameter("ViTri",lookupViTriTD.EditValue==null || lookupViTriTD.EditValue == string.Empty ? null : lookupViTriTD.EditValue),
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel lịch sử tuyển dụng"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/Report_LichSuTuyenDung.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("ReportLichSuTuyenDung" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCLichSuTuyenDung_KeyDown(object sender, KeyEventArgs e)
        {
