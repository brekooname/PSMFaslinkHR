...
{
    public partial class BCChamCongTangCaThang : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) => //hàm lấy dữ liệu chạy ngầm
            {
                ...
                data = controller.GetDataReportOvertime(ucChonDoiTuong_DS1.GetValue(), chonKyLuong1.TuNgay, chonKyLuong1.DenNgay);
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel chấm công tăng ca tháng"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportChamCongTangCaThang.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("ReportChamCongTangCaThang" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        private void grv_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            ...
            if (view == null) return;
            if (e.Column != colEmployeeID && e.Column != colEmployeeName && e.Column != colPosName && e.Column != colDepName_Final && e.Column != colTongGioTangCa)
            {
        ...
        #endregion
        private void BCChamCongTangCaThang_KeyDown(object sender, KeyEventArgs e)
        {
