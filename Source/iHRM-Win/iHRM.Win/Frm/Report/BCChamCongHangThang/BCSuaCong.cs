...
{
    public partial class BCSuaCong : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) => //hàm lấy dữ liệu chạy ngầm
            {
                try
                {
                    ...
                    data = Provider.ExecuteDataTable("p_BaoCao_KetQuaSuaCong"
        ...
        private void btnExcelIn_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/SW_HR_SUACONG.xlsx"); // Tạo excel export helper + đường dẫn template

                ex.WriteToCell("C2", chonKyLuong1.TuNgay.Date.ToString("dd/MM/yyyy"));

                ex.WriteToCell("E2", chonKyLuong1.DenNgay.Date.ToString("dd/MM/yyyy"));

                ex.WriteToCell("I2", LoginHelper.user.caption);

                ex.WriteToCell("I3", DateTime.Now.Date.ToString("dd/MM/yyyy"));

                ex.FillDataTable(data); // Fill BC_FillData

                ex.RendAndFlush("BaoCaoKetQuaSuaCong" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
        ...
        #endregion
        private void BCSuaCong_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Control && e.Shift && e.KeyCode == Keys.T)
            {
                ...
                frm.ShowDialog();
                BCSuaCong_Load(null, null);
            }
        }

        private void BCSuaCong_Load(object sender, EventArgs e)
        {
            TranslateForm();
        }
    }
