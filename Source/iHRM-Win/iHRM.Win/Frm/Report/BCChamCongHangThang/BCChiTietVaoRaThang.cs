...
{
    public partial class BCChiTietVaoRaThang : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) => //hàm lấy dữ liệu chạy ngầm
            {
                ...
                dt = logic.GetReportquetTheMonth(day, todates, ucChonDoiTuong_DS1.GetValue());
                dt.Columns.Add("TT");
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) => //hàm lấy dữ liệu chạy ngầm
            {
                ...
                dtData = logic.GetReportquetTheMonth(day, todates, ucChonDoiTuong_DS1.GetValue());
