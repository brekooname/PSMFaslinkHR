...
{
    public partial class BaoCaoTangCaCoHeSo : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) => //hàm lấy dữ liệu chạy ngầm
            {
                //try
                //{
                data = controller.GetDataReportTangCaCoHeSo(ucChonDoiTuong_DS1.GetValue(), chonKyLuong1.TuNgay, chonKyLuong1.DenNgay);
        ...
        private void btnExcelIn_Click(object sender, EventArgs e)
        {
            ...
            //ge.OnDoing += (bw) =>
            //{
            //    bw.ReportProgress(-1, "Xuất excel bảng tăng ca có hệ số");

            //    #region get data
            //    bw.ReportProgress(-2, "Đang tải dữ liệu...");
            //    DataTable dtData;
            //    dtData = controller.GetDataReportTangCaCoHeSo(ucChonDoiTuong_DS1.GetValue(), chonKyLuong1.TuNgay, chonKyLuong1.DenNgay);
            ...
            //    ExcelExportHelper ex = new ExcelExportHelper("Report/BCChamCongTangCaCoHeSo.xls");
            ...
            //    ex.RendAndFlush("BaoCaoTangCaCoHeSo_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
            //    bw.ReportProgress(2);
            //    #endregion
            //};
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel báo cáo tăng ca có hệ số"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/BCChamCongTangCaCoHeSo.xls"); // Tạo excel export helper + đường dẫn template
                ex.WriteToCell("F6", "Từ ngày " + chonKyLuong1.TuNgay.Date.ToString("dd/MM/yyyy") + " đến ngày " + chonKyLuong1.DenNgay.Date.ToString("dd/MM/yyyy"));
                ex.WriteToCell("I7", ucChonDoiTuong_DS1.getKhoiPBDisPlay());
                ex.SetNamedRangeValue("Ngay", "Ngày in: " + DateTime.Now.ToString("dd/MM/yyyy"));
                ex.FillDataTable(data); // Fill BC_FillData
                ex.RendAndFlush("BCChamCongTangCaCoHeSo_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BaoCaoTangCaCoHeSo_KeyDown(object sender, KeyEventArgs e)
        {
