...
{
    public partial class BCNgayCongTangCaThang : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) => //hàm lấy dữ liệu chạy ngầm
            {
                try
                {
                    data = controller.GetDataReportMonthForm(ucChonDoiTuong_DS1.GetValue(), chonKyLuong1.TuNgay, chonKyLuong1.DenNgay);
        ...
        private void btnXuatExcelKyTen_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) => //hàm lấy dữ liệu chạy ngầm
            {
                var dt = controller.GetDataReportMonthExcel(ucChonDoiTuong_DS1.GetValue(), chonKyLuong1.TuNgay, chonKyLuong1.DenNgay);
        ...
        private void btnExcelIn_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel dữ liệu ngày công tăng ca tháng"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportNgayCongTangCaThang.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("ReportNgayCongTangCaThang" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCNgayCongTangCaThang_KeyDown(object sender, KeyEventArgs e)
        {
