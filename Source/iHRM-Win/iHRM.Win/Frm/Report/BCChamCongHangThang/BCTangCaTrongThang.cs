    ...
    public partial class BCTangCaTrongThang : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) => //hàm lấy dữ liệu chạy ngầm
            {
                try
                {
                    data = controller.GetDataReportTangCaHangThang(ucChonDoiTuong_DS1.GetValue(), chonKyLuong1.TuNgay, chonKyLuong1.DenNgay);
        ...
        private void btnExcelIn_Click(object sender, EventArgs e)
        {
            ...
            //ge.OnDoing += (bw) =>
            //{
            //    bw.ReportProgress(-1, "Xuất excel bảng tăng ca trong tháng");

            //    #region get data
            //    bw.ReportProgress(-2, "Đang tải dữ liệu...");
            //    DataTable dtData;
            //    dtData = controller.GetDataReportTangCaHangThang(ucChonDoiTuong_DS1.GetValue(), chonKyLuong1.TuNgay, chonKyLuong1.DenNgay);
            ...
            //    ExcelExportHelper ex = new ExcelExportHelper("Report/BCChamCongTangCaThang.xls");
            ...
            //    ex.WriteToCell("H7", ucChonDoiTuong_DS1.getKhoiPBDisPlay());
            //    ex.WriteToCell("S7", string.Format("In ngày {0:dd/MM/yyyy}", DateTime.Now));

            //    ex.FillDataTable(dtData);
            //    ex.RendAndFlush("BaoCaoTangCaTrongThang_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
            //    bw.ReportProgress(2);
            //    #endregion
            //};
            ...
            ge.OnDoing += (bw) =>
            {
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/BCChamCongTangCaThang.xls"); // Tạo excel export helper + đường dẫn template
                //ex.WriteToCell("F6", "Từ ngày " + chonKyLuong1.TuNgay.Date.ToString("dd/MM/yyyy") + " đến ngày " + chonKyLuong1.DenNgay.Date.ToString("dd/MM/yyyy"));
                //ex.WriteToCell("H7", ucChonDoiTuong_DS1.getKhoiPBDisPlay());
                ...
                ex.RendAndFlush("BCChamCongTangCaThang_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        private void grv_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Control && e.KeyCode == Keys.C)
            {
                ...
                GridView view = grc.FocusedView as GridView;
        ...
        #endregion
        private void BCTangCaTrongThang_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Control && e.Shift && e.KeyCode == Keys.T)
            {
                ...
                frm.ShowDialog();
                BCTangCaTrongThang_Load(null, null);
            }
        }

        private void BCTangCaTrongThang_Load(object sender, EventArgs e)
        {
            TranslateForm();
        }
    }
