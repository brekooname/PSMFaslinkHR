...
namespace iHRM.Win.Frm.Report
{
    public partial class BCChamCongNew_Fake : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            {
                dt = controller.getDataReportChamCong_new_Fake(ucChonDoiTuong_DS1.GetValue(), chonKyLuong1.TuNgay, chonKyLuong1.DenNgay);
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportChamCong_new.xls"); // Tạo excel export helper + đường dẫn template
        ...
        #endregion
        private void BCChamCongNew_KeyDown(object sender, KeyEventArgs e)
        {
