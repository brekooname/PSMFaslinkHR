...
{
    public partial class BCNhanVienDuoi18Tuoi : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s,ev) => //hàm lấy dữ liệu chạy ngầm
            {
                ...
                if (day != null)
                {
                    data = logic.GetReportNVDuoi18Tuoi(day, ucChonDoiTuong_DS1.GetValue());
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel dữ liệu nhân viên dưới 18 tuổi"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportNhanVienDuoi18Tuoi.xls"); // Tạo excel export helper + đường dẫn template
                ex.InsertImage(0, 0, 1, 2, LoginHelper.Company.LogoCompany);
                ex.WriteToCell("C1", LoginHelper.Company.CompanyName);
                ex.WriteToCell("A4", "Tính đến ngày: " + dateNgay.DateTime.ToString("dd/MM/yyyy"));
                ex.SetNamedRangeValue("Ngay", "Ngày tạo: " + DateTime.Now.ToString("dd/MM/yyyy"));
                ex.FillDataTable(data); // Fill BC_FillData
                ex.RendAndFlush("BaoCaoNhanVienDuoi18Tuoi_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCNhanVienDuoi18Tuoi_KeyDown(object sender, KeyEventArgs e)
        {
