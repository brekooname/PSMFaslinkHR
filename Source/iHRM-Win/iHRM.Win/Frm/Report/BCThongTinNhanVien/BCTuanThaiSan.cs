...
{
    public partial class BCTuanThaiSan : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dw_it.OnDoing = (s,ev) => //hàm lấy dữ liệu chạy ngầm
                {
                    ...
                    data = logic.GetReportTuanThaiSan(ngayTimKiem, ucChonDoiTuong_DS1.GetValue());
                    if (data.Rows.Count > 0)
                    {
                        dw_it.bw.ReportProgress(1, data.AsEnumerable().OrderBy(p => p["DepName_Final"]).CopyToDataTable());
                    }
                    else
                    {
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            //ge.OnDoing += (bw) =>
            //{
            //    bw.ReportProgress(-1, "Xuất excel dữ liệu nhân viên hết hạn thai sản"); // Set caption
            ...
            //    ExcelExportHelper ex = new ExcelExportHelper("Report/ReportNhanVienHetHanThaiSan.xls"); // Tạo excel export helper + đường dẫn template
            ...
            //    ex.RendAndFlush("BaoCaoNhanVienHetHanThaiSan_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
            //    bw.ReportProgress(2);
            //    #endregion
            //};
