...
{
    public partial class BCNhatKyNguoiDung : frmBase
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s, ev) => //hàm lấy dữ liệu chạy ngầm
            {
                dcDatabaseDataContext db = new dcDatabaseDataContext(Provider.ConnectionString);
                    dt = Provider.ExecuteDataTableReader("p_BaoCao_GettbLogs",
        ...
        private void btnXuatExel_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel nhật ký người dùng"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/BaoCaoNhatKyNguoiDung.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("BaoCaoNhatKyNguoiDung_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCNhatKyNguoiDung_KeyDown(object sender, KeyEventArgs e)
        {
