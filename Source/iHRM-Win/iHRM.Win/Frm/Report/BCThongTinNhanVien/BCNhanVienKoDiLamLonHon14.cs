...
{
    public partial class BCNhanVienKoDiLamLonHon14 : frmBase
    {
        ...
        public BCNhanVienKoDiLamLonHon14()
        {
            InitializeComponent();
        }
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            {
                    data = logic.GetReportNVKoDiLamLonHon14(chonKyLuong1.TuNgay.Date,chonKyLuong1.DenNgay.Date);
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel dữ liệu nhân viên không đi làm lơn hơn 14"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportNhanVienKoDiLamLonHon14.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("BaoCaoNhanVienKhongDiLamLonHon14_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
