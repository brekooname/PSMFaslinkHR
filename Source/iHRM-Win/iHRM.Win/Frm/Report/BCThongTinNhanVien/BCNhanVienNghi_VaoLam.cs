...
{
    public partial class BCNhanVienNghi_VaoLam : frmBase
    {
        ...
        public BCNhanVienNghi_VaoLam()
        {
            InitializeComponent();
            List<TimKiem> _lGioitinh = new List<TimKiem>();
            _lGioitinh.Add(new TimKiem { text = "Tất cả", value = "tatca" });
            _lGioitinh.Add(new TimKiem { text = "Nam", value = "Nam" });
            _lGioitinh.Add(new TimKiem { text = "Nữ", value = "Nữ" });
            List<TimKiem> _lTimKiem = new List<TimKiem>();
            _lTimKiem.Add(new TimKiem { text = "Tìm kiếm tất cả", value = "tatca" });
            _lTimKiem.Add(new TimKiem { text = "Tìm kiếm NV nghỉ làm", value = "nghilam" });
            _lTimKiem.Add(new TimKiem { text = "Tìm kiếm NV còn làm việc", value = "danglamviec" });
            _lTimKiem.Add(new TimKiem { text = "Tìm kiếm NV vào làm", value = "vaolam" });
            lookupGioiTinh.Properties.DataSource = _lGioitinh;
            lookupTimKiem.Properties.DataSource = _lTimKiem;
            lookupTimKiem.EditValue = "tatca";
            lookupGioiTinh.EditValue = "tatca";
        }
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            dw_it.OnDoing = (s,ev) => //hàm lấy dữ liệu chạy ngầm
            {
                ...
                {
                    string fieldSearch = lookupTimKiem.EditValue.ToString();
                    string strGioiTinh = lookupGioiTinh.EditValue.ToString();
                    data = logic.GetReportNhanVien(day, todates, ucChonDoiTuong_DS1.GetValue(), fieldSearch, strGioiTinh);
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel dữ liệu nhân viên nghỉ - vào làm"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportNhanVienNghi_VaoLam.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("BaoCaoDanhSachNhanVienNghi_VaoLam_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        private void toolStripExcelATM_Click(object sender, EventArgs e)
        {
            SaveFileDialog sd = new SaveFileDialog(); // Tạo dialog Save
            sd.Filter = "Excel 2007|*.xls";
            if (sd.ShowDialog() != DialogResult.OK)
            ...
            ge.OnDoing += (bw) =>
            {
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportNhanVienNghi_VaoLam_ATM.xls"); // Tạo excel export helper + đường dẫn template
                ex.WriteToCell("A4", "Từ ngày " + chonKyLuong1.TuNgay.Date.ToString("dd/MM/yyyy") + " đến ngày " + chonKyLuong1.DenNgay.Date.ToString("dd/MM/yyyy"));
                ex.InsertImage(0, 0, 1, 2, LoginHelper.Company.LogoCompany);
                ex.WriteToCell("C1", LoginHelper.Company.CompanyName);
                ex.SetNamedRangeValue("Ngay", "Ngày tạo: " + DateTime.Now.ToString("dd/MM/yyyy"));
                ex.FillDataTable(data); // Fill BC_FillData
                ex.RendAndFlush("BaoCaoDanhSachNhanVienNghi_VaoLam_ATM" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
        ...
        #endregion
        private void BCNhanVienNghi_VaoLam_KeyDown(object sender, KeyEventArgs e)
        {
