...
{
    public partial class BCHopDongHetHan : frmBase
    {
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            ge.OnDoing += (bw) =>
            {
                bw.ReportProgress(-1, "Xuất excel dữ liệu hợp đồng hết hạn"); // Set caption
                ...
                ExcelExportHelper ex = new ExcelExportHelper("Report/ReportHopDongHetHan.xls"); // Tạo excel export helper + đường dẫn template
                ...
                ex.RendAndFlush("BaoCaoHopDongHetHan_" + DbHelper.DrGetString(LoginHelper.Dept, "code"), sd.FileName);
                bw.ReportProgress(2);
                #endregion
            };
