...
{
    public partial class BCNhanVienHetHanThaiSan : frmBase
    {
        ...
        public BCNhanVienHetHanThaiSan()
        {
            InitializeComponent();
        }
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dw_it.OnDoing = (s,ev) => //hàm lấy dữ liệu chạy ngầm
                {
                    ...
                    data = logic.GetReportNVHetHanNghiThaiSan(ngayTimKiem, ucChonDoiTuong_DS1.GetValue(), soNgay);
