...
namespace iHRM.Win.Frm.Category
{
    public partial class dlgDepartment : dlgBase
    {
        public dlgDepartment()
        {
            ...
            dlgData.CB.Add(new ControlBinding("Khoi", txt_Khoi, ControlBinding_DataType.String));
            dlgData.CB.Add(new ControlBinding("LoaiCT", txt_LoaiCT, ControlBinding_DataType.Int));
            dlgData.CB.Add(new ControlBinding("CenterCode", txtCenterCode, ControlBinding_DataType.String));

            txtCenterCode.Properties.DataSource = Cls.CacheDataTable.GetCacheDataTable("tblRef_CenterCode");
        }
