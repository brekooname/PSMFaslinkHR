...
{
    public partial class impEmployee_Child : i_Import.FixImporter
    {
        /// <summary>
        ...
        public impEmployee_Child()
        {
            InitializeComponent();
        }

        private void impEmployee_Child_Load(object sender, EventArgs e)
        {
        ...
        private void impEmployee_OnImportRow(DataRow dr)
        {
            try
            {
                ...
                var ret = Provider.ExecuteNonQuery("p_Emp_ExcelImport_Child", dr);
