...
{
    public partial class impEmployee_PC : i_Import.FixImporter
    {
        /// <summary>
        ...
        public impEmployee_PC()
        {
            InitializeComponent();
        }

        private void impEmployee_PC_Load(object sender, EventArgs e)
        {
        ...
        private void impEmployee_OnImportRow(DataRow dr)
        {
            try
            {
                ...
                var ret = Provider.ExecuteNonQuery("p_Emp_ExcelImport_PC", dr);
