...
{
    public partial class impEmployee_HD4 : i_Import.FixImporter
    {
        /// <summary>
        ...
        public impEmployee_HD4()
        {
            InitializeComponent();
        }

        private void impEmployee_HD4_Load(object sender, EventArgs e)
        {
        ...
        private void impEmployee_OnImportRow(DataRow dr)
        {
            try
            {
                ...
                var ret = Provider.ExecuteNonQuery("p_Emp_ExcelImportHD_v2", dr);
