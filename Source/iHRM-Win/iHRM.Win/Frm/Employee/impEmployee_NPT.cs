...
{
    public partial class impEmployee_NPT : i_Import.FixImporter
    {
        /// <summary>
        ...
        public impEmployee_NPT()
        {
            InitializeComponent();
        }

        private void impEmployee_NPT_Load(object sender, EventArgs e)
        {
        ...
        private void impEmployee_OnImportRow(DataRow dr)
        {
            try
            {
                ...
                var ret = Provider.ExecuteNonQuery("p_Emp_ExcelImport_NguoiPhuThuoc", dr);

                LogAction.LogAction.PushLog("Import người phụ thuộc"
