...
namespace iHRM.Win.Frm.Employee.ViewNhanVienThuViec
{
    public partial class frmNhanVienTuDanhGia : dlgBase
    {
        ...
        {
            txtLyDoQTThucHienCVChung.Enabled = radQTThucHienViecChung.SelectedIndex == 1 ? false : false;
        ...
        {
            txtLyDoQTThucHienCVTaiPB.Enabled = radQTThucHienCVTaiPB.SelectedIndex == 1 ? false : false;
        ...
        private void radMoiTruongLamViecChung_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtMoiTruongLamViecChung.Enabled = radMoiTruongLamViecChung.SelectedIndex == 1 ? false : false;
        ...
        {
            txtMoiTruongLamViecTaiPB.Enabled = radMoiTruongLamViecTaiPB.SelectedIndex == 1 ? false : false;
        ...
        {
            txtLyDoQD_QT_CS.Enabled = radQD_QT_CS.SelectedIndex == 1 ? false : false;
        ...
        {
            txtHD.Enabled = radHD.SelectedIndex == 1 ? false : false;
