...
{
    public partial class impEmployee_Luong : i_Import.FixImporter
    {
        /// <summary>
        ...
        public impEmployee_Luong()
        {
            InitializeComponent();
        }

        private void impEmployee_Luong_Load(object sender, EventArgs e)
        {
        ...
        private void impEmployee_OnPreData()
        {
            ...
            this.dtDataExcelImported.Columns.Add(new DataColumn("PosID"));

            this.dtDataExcelImported.Columns.Add(new DataColumn("hdld_loaihdID"));
            ...
            this.dtDataExcelImported.Columns.Add(new DataColumn("hdld4_loaihdID"));

            this.dtDataExcelImported.Columns.Add(new DataColumn("hdld_PosID"));
            ...
            this.dtDataExcelImported.Columns.Add(new DataColumn("hdld4_PosID"));
            ...
            this.dtDataExcelImported.Columns.Add(new DataColumn("RaceID"));
        ...
        private void impEmployee_OnImportRow(DataRow dr)
        {
            try
            {
                ...
                //dr["PosID"] = GetID_ds(dsDM.Tables[8], "PosName", dr["PosName"] as string, "PosID");
                ...
                //dr["hdld4_loaihdID"] = GetID_ds(dsDM.Tables[2], "ContractTypeName", dr["hdld4_loaihd"] as string, "ContractTypeID");

                //// Chưa điền bảng
                dr["hdld_PosID"] = GetID_ds(dsDM.Tables[8], "PosName", dr["hdld_PosName"] as string, "PosID");
                ...
                //dr["hdld4_PosID"] = GetID_ds(dsDM.Tables[8], "PosName", dr["hdld4_PosName"] as string, "PosID");

                //dr["BankID"] = GetID_ds(dsDM.Tables[9], "BankName", dr["BankName"] as string, "BankID");

                //dr["BHXH_RaceID"] = GetID_ds(dsDM.Tables[10], "RaceName", dr["BHXH_RaceID"] as string, "RaceID");
                ...
                var ret = Provider.ExecuteNonQuery("p_Emp_ExcelImport_03", dr);
        ...
        private void ImpEmployee_OnDownLoadFileTemplate(string saveFileTo)
        {
            ...
            ex.WriteDataTable_NoInsert(dsDM.Tables[10], "L2");
